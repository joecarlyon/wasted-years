...
const originPhotos = [
  {
    src: '/images/origins/20110425_001.jpg',
    alt: 'The Bayou Classic 30-quart turkey fryer — our first brew kettle',
    caption:
      'The Bayou Classic 30-quart turkey fryer — our first "brew kettle"',
  },
  {
    src: '/images/origins/20110425_002.jpg',
    alt: 'Grain in cheesecloth mashing on the apartment stove',
    caption: 'All-grain with no-brain: cheesecloth mash on the apartment stove',
  },
  {
    src: '/images/origins/20110425_003.jpg',
    alt: 'The boil going in the turkey fryer pot',
    caption: 'The boil',
  },
  {
    src: '/images/origins/20110426_001.jpg',
    alt: 'Cooling the wort in a bathtub ice bath',
    caption: 'Ice bath in the tub — our state-of-the-art chiller',
  },
  {
    src: '/images/origins/20110426_002.jpg',
    alt: 'Siphoning wort into the fermentation bucket',
    caption: 'Siphoning into the fermentation bucket',
  },
  {
    src: '/images/origins/20110426_004.jpg',
    alt: 'Close-up of wort flowing through the siphon tube',
    caption: 'Wort flowing through the siphon',
  },
  {
    src: '/images/origins/20110429_001.jpg',
    alt: 'Wort in a glass carboy',
    caption: 'Into the carboy',
  },
  {
    src: '/images/origins/20110429_005.jpg',
    alt: 'Fermenting beer in a carboy with temperature strip',
    caption:
      'Fermentation underway — with a stick-on thermometer for "temperature control"',
  },
  {
    src: '/images/origins/20110429_006.jpg',
    alt: 'Dark beer fermenting in a carboy',
    caption: 'The dark stuff fermenting',
  },
]
    ...
    <main className="mx-auto max-w-6xl px-4 py-8 md:px-8">
      <section className="mb-12">
        ...
        <div className="space-y-4 text-text-secondary">
          ...
          <p>
            ...
            <a
              href="https://www.goodreads.com/book/show/32446869"
              target="_blank"
          ...
          <p>
            ...
            better than what we made. But instead of giving up, we got even more
            into it. We wanted to figure it out. Over the next few years, we
            kept tinkering with different homemade setups, turning all shapes
          ...
          <p>
            ...
            The Dream, and Tony wanted to learn the ropes, so he took over where
            we left off. I was moving every year, so the whole brewing setup got
            dragged to Tony&apos;s garage. We had a ton of good times there!
            Brewing turned into a full-on social event, with a rotating crew of
            friends and friends-of-friends dropping in, learning the process,
            and helping out (while we, of course, crushed way too many beers
          ...
          <p>
            ...
            instead of BeerSmith, we brew on actual equipment (not just a turkey
            fryer), and sometimes I throw beers into competitions, where
      ...
      <section className="mb-12">
        ...
        <p className="mb-8 text-text-secondary">
          Photos from brew day one. A Bell&apos;s Two Hearted clone brewed on a
          turkey fryer pot, mashed in cheesecloth, and cooled in the bathtub.
        </p>
