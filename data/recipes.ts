...
export const recipes: Recipe[] = [
  ...
  {
    "id": 76,
    "uuid": "7ff0db1e-7ff0-4ff0-7ff0-7ff0db1e7ff0",
    "name": "Overlord v4.0 5g",
    "style": "American IPA",
    "category": "ale",
    "description": "American IPA for 2026 NHC. Evolved from Overlord v3.1. Simplified grain bill (removed crystal, carapils, rye). Diversified hop aroma (added Simcoe + Nelson Sauvin). Switched to RO water with targeted mineral additions.\n\nNOTE: I need to probably collect an extra ~0.75g of water due to how much the hops are going to soak up in the boil, so I should get 3g of sparge, not 2.",
    "og": 1.07,
    "fg": 1.014,
    "abv": 7.4,
    "ibu": 71,
    "grains": [
      ...
      "0.34 lb Munich Malt - Light",
      "0.23 lb Flaked Barley"
    ],
    "hops": [
      "1 oz Citra (Boil)",
      "2 oz Citra (Boil)",
